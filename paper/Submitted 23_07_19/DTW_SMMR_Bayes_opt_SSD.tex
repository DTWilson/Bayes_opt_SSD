...
\documentclass[sagev, doublespace, Crown]{sagej}
...
\begin{figure}
\centering
\includegraphics[scale=0.8]{fig3_GP_example.eps}
...
\begin{figure}
\centering
\includegraphics[scale=0.8]{fig7_ex3_single_run.eps}
